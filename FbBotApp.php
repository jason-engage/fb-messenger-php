...
class FbBotApp
{
     ...
     */
     ...
     public function debug($fb_id, $message, $notification_type = "REGULAR")
     {
          ...
          for ($x=0; $x<$pages; $x++) {
              ...
              $responses[] = $this->send( new Message($fb_id,substr( json_encode( $message, JSON_UNESCAPED_SLASHES ), $x*$maxlength, $maxlength), false, "ISSUE_RESOLUTION", $notification_type, "MESSAGE_TAG" ) );
     ...
     * @return UserProfile
     */
    public function userProfile($id, $fields = 'first_name,last_name,profile_pic')
    {
        //PERMISSIONS NEEDED - locale,timezone,gender
